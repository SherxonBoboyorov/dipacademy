...
class AdmissionController extends Controller
{
    ...
    public function store(CreateAdmission $request)
    {
        ...
        if(Admission::create($data)) {
            return redirect()->route('admission.index')->with('message', "Admission created seccessfully!!!");
        }
    ...
    public function update(UpdateAdmission $request, $id)
    {
        ...
        if ($admission->update($data)) {
            return redirect()->route('admission.index')->with('message', "Admission changed successfully!!!");
        }
