        ...
        <section class="container">
            <div class="academy__cart">
                ...
                <ul class="academy__menu">
                    ...
                    <li>
                        <a href="FacultyPracticalDiplomacy.html " class="academy__menu__link">Факультет практической дипломатии</a>
                    </li>
                </ul>
            </div>
        </section>
                ...
                <div class="departmentsStaff_In__list">
                    <aside>
                        ...
                        <ul class="departmentsStaff_In__menu">
                            ...
                            <li class="active">
                                <a href="#!" class="departmentsStaff_In__menu__link">
                    ...
                    <section class="departmentsStaff_In__cart__item">
                        ...
                        <div class="departmentsStaff_In__cart__list">
                            ...
                            <div class="departmentsStaff_In__item__list">
                                <a href="command_in.html">
                                    <div class="departmentsStaff_In__img">
                                        <img src="foto/leadership_1.png" alt="departmentsStaff">
                                    </div>
                            ...
                            <div class="departmentsStaff_In__item__list">
                                <a href="command_in.html">
                                    <div class="departmentsStaff_In__img">
                                        <img src="foto/leadership_2.png" alt="departmentsStaff">
                                    </div>
                            ...
                            <div class="departmentsStaff_In__item__list">
                                <a href="command_in.html">
                                    <div class="departmentsStaff_In__img">
                                        <img src="foto/leadership_3.png" alt="departmentsStaff">
                                    </div>
