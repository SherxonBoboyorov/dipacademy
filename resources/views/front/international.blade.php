        ...
        <section class="container">
            <div class="academy__cart">
                ...
                <ul class="academy__menu">
                    ...
                    <li>
                        <a href="International.html" class="academy__menu__link">International</a>
                    </li>
                </ul>
            </div>
        </section>
    ...
    <div class="programmes_in">
        <section class="container">
            <div class="programmes_in__cart">
                ...
                <div class="programmes_in__item">
                    <h2 class="about__title__h2">consectetur adipiscing elit</h2>

                    <ul class="programmes_in__item__menu">
                        <li>
                            <div class="academy_contint__text clearfix">
                        ...
                        <li>
                            <div class="academy_contint__text clearfix">
                                <p>NUt enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit, qui in ea voluptate velit esse, quam nihil molestiae consequatur, vel illum, qui dolorem eum fugiat, quo voluptas nulla pariatur?</p>
                            </div>
                        </li>
                ...
                <div class="programmes_in__item">
                    <div class="academy_contint__text clearfix">
                        <img src="foto/International_1.png" alt="research">
                        <img src="foto/International_2.png" alt="research">
                        <p>
                ...
                <div class="programmes_in__video">
                    <p class="text-center">
                        <a data-fancybox href="video/video_2022-12-23_16-09-42.mp4">
                            <section>
                                <img class="inline" width="500" alt="" src="foto/International_3.png"/>
                                <!-- play start -->
                ...
                <div class="programmes_in__item clearfix">
                    ...
                    <div class="programmes_in__img">
                        <img src="foto/International_4.png" alt="programmes">
                    </div>
