                    ...
                    <div class="programmes_in__reviews__list">
                        ...
                        <div class="programmes_in__reviews__item">
                            <div class="programmes_in__reviews__img">
                                <img src="{{ asset($programinreviw->image) }}" alt="">
                            </div>

                            <h3 class="programmes_in__reviews__name">{{ $programinreviw->{'name_' . app()->getLocale()} }}</h3>
                            <h4 class="programmes_in__reviews__graduate">{{ $programinreviw->{'graduate_' . app()->getLocale()} }}</h4>
                            <div class="programmes_in__reviews__text">
                                <p>
                                    {!! $programinreviw->{'content_' . app()->getLocale()} !!}
                                </p>
                            </div>
                        </div>
                        @endforeach
