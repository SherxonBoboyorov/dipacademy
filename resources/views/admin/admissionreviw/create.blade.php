...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admissionreviw.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            <label>AdmissionIn</label>
                            <select name="admissionIn_id" id="admissionIn_id" class="form-control">
                                @foreach ($admissionins as $admissionin)
                                    <option value="{{ $admissionin->id }}">{{ $admissionin->title_en }}</option>
                                @endforeach
                            </select>
