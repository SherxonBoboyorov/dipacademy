...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Alumni reviews</h4>
                </div>
            </div>
        ...
        <form action="{{ route('admissionmasterreviw.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            <label>Admission Master_In</label>
                            <select name="admissionmasterIn_id" id="admissionmasterIn_id" class="form-control">
                                @foreach ($admissionmasterins as $admissionmasterin)
                                    <option value="{{ $admissionmasterin->id }}">{{ $admissionmasterin->title_en }}</option>
                                @endforeach
                            </select>
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            ...
                            <input type="text" id="graduate_uz" class="form-control" name="graduate_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="graduate_ru" class="form-control" name="graduate_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="graduate_en" class="form-control" name="graduate_en">
