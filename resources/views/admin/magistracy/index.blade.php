                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="table_cart_list">{!! $magistracy->description_uz !!}</td>
                            <td class="table_cart_list">{!! $magistracy->description_ru !!}</td>
                            <td class="table_cart_list">{!! $magistracy->description_en !!}</td>
                            <td>
