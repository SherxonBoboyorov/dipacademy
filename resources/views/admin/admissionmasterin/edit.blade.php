        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit AdmissionMasterIn</h4>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="course_type_uz" value="{{ $admissionmasterin->course_type_uz }}" class="form-control" name="course_type_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="course_type_ru" value="{{ $admissionmasterin->course_type_ru }}" class="form-control" name="course_type_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="course_type_en" value="{{ $admissionmasterin->course_type_en }}" class="form-control" name="course_type_en">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="delivery_mode_uz" value="{{ $admissionmasterin->delivery_mode_uz }}" class="form-control"name="delivery_mode_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="delivery_mode_ru" value="{{ $admissionmasterin->delivery_mode_ru }}" class="form-control" name="delivery_mode_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="delivery_mode_en" value="{{ $admissionmasterin->delivery_mode_en }}" class="form-control" name="delivery_mode_en">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="study_mode_uz" value="{{ $admissionmasterin->study_mode_uz }}" class="form-control" name="study_mode_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="study_mode_ru" value="{{ $admissionmasterin->study_mode_ru }}" class="form-control" name="study_mode_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="study_mode_en" value="{{ $admissionmasterin->study_mode_en }}" class="form-control" name="study_mode_en">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="duration_uz" value="{{ $admissionmasterin->duration_uz }}" class="form-control" name="duration_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="duration_ru"  value="{{ $admissionmasterin->duration_ru }}" class="form-control" name="duration_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="duration_en" value="{{ $admissionmasterin->duration_en }}" class="form-control" name="duration_en">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="start_date_uz" value="{{ $admissionmasterin->start_date_uz }}" class="form-control" name="start_date_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="start_date_ru" value="{{ $admissionmasterin->start_date_ru }}" class="form-control" name="start_date_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="start_date_en" value="{{ $admissionmasterin->start_date_en }}" class="form-control" name="start_date_en">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="application_deadline_uz" value="{{ $admissionmasterin->application_deadline_uz }}" class="form-control" name="application_deadline_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="application_deadline_ru" value="{{ $admissionmasterin->application_deadline_ru }}" class="form-control" name="application_deadline_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="application_deadline_en" value="{{ $admissionmasterin->application_deadline_en }}" class="form-control" name="application_deadline_en">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <textarea name="content_uz" class="my-editor" id="content_uz"cols="30" rows="10">{{ $admissionmasterin->content_uz }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="content_ru" class="my-editor" id="content_ru" cols="30" rows="10">{{ $admissionmasterin->content_ru }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="content_en" class="my-editor" id="content_en" cols="30" rows="10">{{ $admissionmasterin->content_en }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_ru" class="form-control" id="meta_title_ru" cols="30" rows="5">{{ $admissionmasterin->meta_title_ru }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_ru" class="form-control" id="meta_description_ru" cols="30" rows="5">{{ $admissionmasterin->meta_description_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_uz" class="form-control" id="meta_title_uz" cols="30" rows="5">{{ $admissionmasterin->meta_title_uz }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_uz" class="form-control" id="meta_description_uz" cols="30" rows="5">{{ $admissionmasterin->meta_description_uz }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_en" class="form-control" id="meta_title_en" cols="30" rows="5">{{ $admissionmasterin->meta_title_en }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_en" class="form-control" id="meta_description_en" cols="30" rows="5">{{ $admissionmasterin->meta_description_en }}</textarea>
